...
export function getUserSpecificSessionKey(agentId: string): string {
...
export function loadSettings(): UiSettings {
  ...
  const defaults: UiSettings = {
    ...
    sessionKey: getUserSpecificSessionKey("main"),
    lastActiveSessionKey: getUserSpecificSessionKey("main"),
    theme: "claw",
    themeMode: "system",
    chatFocusMode: false,
  ...
  try {
    ...
    const sessionKey = parsedSessionKey || defaults.sessionKey;
