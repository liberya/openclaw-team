...
> &
  Pick<CronModelSuggestionsState, "cronModelSuggestions"> & {
    ...
    modelsList: ModelProvider[];
    modelsPresets: ProviderPreset[];
    modelsShowAddForm: boolean;
    modelsManualInput: boolean;
    modelsManualProviderId: string;
    viewingModelsProvider: ModelProvider | null;
    editingModel: ModelProvider | null;
