...
export function createSessionsSpawnTool(
  ...
  return {
    ...
    name: "sessions_spawn",
    description:
      'Spawn a TEMPORARY subagent for one-shot tasks or parallel work. This creates a short-lived subagent that disappears after completion. For creating a PERSISTENT named agent the user can manage from the Agents page, use the gateway tool with action=agents.create instead. mode="run" is one-shot and mode="session" is persistent/thread-bound. Subagents inherit the parent workspace directory automatically.',
